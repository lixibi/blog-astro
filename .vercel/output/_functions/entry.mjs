...
import { c as createExports } from './chunks/entrypoint_CrodO0PZ.mjs';
import { manifest } from './manifest_BuR9-NyR.mjs';
...
const _page14 = () => import('./pages/recommendations.astro.mjs');
...
const pageMap = new Map([
    ...
    ["node_modules/.pnpm/astro-decap-cms-oauth@0.5.1_astro@5.0.3_@types+node@22.10.1_jiti@1.21.6_rollup@4.28.0_typescript@5.7.2_yaml@2.6.1_/node_modules/astro-decap-cms-oauth/src/oauth/callback.ts", _page9],
    ["node_modules/.pnpm/astro-decap-cms-oauth@0.5.1_astro@5.0.3_@types+node@22.10.1_jiti@1.21.6_rollup@4.28.0_typescript@5.7.2_yaml@2.6.1_/node_modules/astro-decap-cms-oauth/src/oauth/index.ts", _page10],
    ["src/pages/og-image/[...slug].png.ts", _page11],
    ["src/pages/posts/[...page].astro", _page12],
    ["src/pages/posts/[...slug].astro", _page13],
    ["src/pages/recommendations/index.astro", _page14],
...
const _args = {
    "middlewareSecret": "63240e1b-09a4-4258-a2ae-a9115f3e472a",
